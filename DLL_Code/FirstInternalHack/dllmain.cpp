...
//The current DLL was wrote for an older game but by using the same code and by chaning the addresses you can make it work for any game if it doesnt have an anticheat
